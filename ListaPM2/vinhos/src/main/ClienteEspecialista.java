...
public class ClienteEspecialista extends Cliente {
    private static final double MODIFICADOR_ESPECIALISTA = 1.6;
    private static final double TAXA_FRETE = 10;
    private static final double DESCONTO_FIXO = 0.15;
    public ClienteEspecialista(String nome, String cpf, String senha, String email) {
        super(nome, cpf, senha, email);
    }
    @Override
    public double calcularMensalidade() {
        mensalidade = VALOR_MENSALIDADE * MODIFICADOR_ESPECIALISTA;
        return mensalidade;
    }
    @Override
